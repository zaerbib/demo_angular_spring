...
CREATE TABLE public.products (
  ...
  discontinued    int2 NOT NULL DEFAULT '0',
  category        VARCHAR(50),
  PRIMARY KEY (id)
);
...
/* Foreign Key: orders */
ALTER TABLE public.orders ADD CONSTRAINT fk_orders__customers FOREIGN KEY (customer_id) REFERENCES customers(id);
ALTER TABLE public.orders ADD CONSTRAINT fk_orders__employees FOREIGN KEY (employee_id) REFERENCES employees(id);
/* Foreign Key:  order_items */
ALTER TABLE public.order_items ADD CONSTRAINT fk_order_items__orders      FOREIGN KEY (order_id) REFERENCES orders(id);
ALTER TABLE public.order_items ADD CONSTRAINT fk_order_items__products    FOREIGN KEY (product_id) REFERENCES products(id);

/* Views */
CREATE OR REPLACE VIEW public.order_info AS
